...
# -*- coding: utf-8 -*-
"""
최종 완벽 번역 스크립트 - 11개 언어 × (FAQ 35개 + 모든 UI)
...
print(f"✅ 한국어 FAQ {len(faq_ko)}개 로드 완료")

# 11개 언어 완전 번역 데이터 (모든 언어 포함)
TRANSLATIONS = {
    'ko': {
        'name': '한국어',
    ...
    'ja': {
        ...
        'cat8': '多言語・グローバル',
        'faq': [
            {'q': 'このサービスは何ですか？', 'a': 'AI通話アシスタントは、AIが電話、音声、メッセンジャーの会話に応答、録音し、通話内容を自動的に要約、保存、分析するサービスです。'},
            {'q': 'いつ使用すべきですか？', 'a': '営業電話、カスタマーサービス、契約交渉、国際電話、通話記録管理が必要なすべての状況で使用できます。'},
            {'q': 'AIは実際に電話に応答しますか？', 'a': 'はい。仮想番号を通じて、AIは直接電話を受けて人間のように会話できます。'},
            {'q': '人が通話中でも使用できますか？', 'a': 'はい。ユーザーが通話中の場合、AIは同時に録音、要約、分析を実行します。'},
            {'q': '通話内容は自動的に保存されますか？', 'a': '録音同意が有効になっている場合、すべての通話は自動的に保存されます。'},
            {'q': '通話はどのように録音されますか？', 'a': '音声はリアルタイムでテキストに変換され、元の音声とともに保存されます。'},
            {'q': '通話要約はどのような形式ですか？', 'a': '重要なポイントの3〜5行の要約と、主要な合意事項とアクション項目が自動的に整理されます。'},
            {'q': '複数の話者は区別されますか？', 'a': 'はい。話者分離機能により、誰が何を言ったかが区別されます。'},
            {'q': '感情を分析しますか？', 'a': 'はい。怒り、中立、満足などの感情状態を自動的に分析します。'},
            {'q': '過去の通話を検索できますか？', 'a': '「先月の契約通話」のような自然言語で検索できます。'},
            {'q': 'AI交渉アシスタントは何をしますか？', 'a': '通話中に相手の発言を分析し、交渉戦略、推奨フレーズ、リスク警告を提供します。'},
            {'q': '交渉中に相手にAIが見えますか？', 'a': 'いいえ。交渉ガイドはユーザーにのみプライベートで表示されます。'},
            {'q': '価格交渉を支援しますか？', 'a': 'はい。価格、スケジュール、条件を総合的に分析して最適な代替案を提案します。'},
            {'q': '通話録音は合法ですか？', 'a': '各国の録音法に従って自動ガイダンスメッセージが適用されます。'},
            {'q': 'データは安全に保存されますか？', 'a': 'すべてのデータは暗号化されて保存されます。'},
            {'q': '法的証拠として使用できますか？', 'a': 'タイムスタンプとハッシュ値が含まれており、証拠として使用できます。'},
            {'q': '無料で使用できますか？', 'a': '基本要約機能は無料プランで提供されます。'},
            {'q': 'エンタープライズプランはどうですか？', 'a': 'ユーザー数と機能に基づいてカスタマイズされたプランが提供されます。'},
            {'q': 'コールセンターに適用できますか？', 'a': 'はい。相談自動化と品質管理機能を提供します。'},
            {'q': '始めるにはどうすればよいですか？', 'a': 'サインアップ後、仮想番号を作成することですぐに使用を開始できます。'},
            {'q': '通話後に契約は自動的に整理されますか？', 'a': 'はい。通話内容に基づいて契約要約または草案を生成できます。'},
            {'q': '口頭合意は記録されますか？', 'a': '通話中の合意内容は自動的に抽出され、契約条項と照合されます。'},
            {'q': '音声コマンドを出せますか？', 'a': '「この通話を要約してメールで送信」のような音声コマンドが可能です。'},
            {'q': 'CRMと統合されますか？', 'a': 'SalesforceやHubSpotなどの主要CRMと統合されます。'},
            {'q': '会議議事録や提案書を作成できますか？', 'a': '通話終了後に自動的に生成できます。'},
            {'q': 'AI対AI通話とはどういう意味ですか？', 'a': '当社のAIと相手企業のAIが直接通信して条件を事前調整します。'},
            {'q': '人間の介入は全く必要ありませんか？', 'a': 'プリセット範囲内でのみ可能で、最終承認には人間の介入が必要です。'},
            {'q': '多言語交渉は機能しますか？', 'a': 'はい。各AIは異なる言語でリアルタイムに交渉できます。'},
            {'q': 'AI対AI通話記録は保存されますか？', 'a': 'すべてのAI↔AI通話は音声、テキスト、合意ログとして保存されます。'},
            {'q': 'どの言語がサポートされていますか？', 'a': '韓国語、英語、日本語、中国語、スペイン語、フランス語などがサポートされています。'},
            {'q': '国際番号は提供されますか？', 'a': '国別に仮想番号（DID）が提供されます。'},
            {'q': 'リアルタイム翻訳は可能ですか？', 'a': '通話中のリアルタイム翻訳と翻訳要約が利用可能です。'},
            {'q': '交渉成功確率を見ることができますか？', 'a': '通話中にリアルタイムで契約成功確率が提供されます。'},
            {'q': '交渉の練習ができますか？', 'a': 'はい。実際の通話前にAI相手と交渉シミュレーションができます。'},
            {'q': 'GDPRまたはCCPAに準拠していますか？', 'a': 'はい。グローバルプライバシー保護規制に準拠しています。'}
        ]
    },
    'hi': {
        'name': 'हिन्दी',
        'page_title': 'CallMind AI - एआई कॉल सहायक प्लेटफ़ॉर्म',
        'hero_title': 'एआई-संचालित<br>इंटेलिजेंट कॉल सहायक',
        'hero_subtitle': 'एआई कॉल का जवाब देता है, रिकॉर्ड करता है, सारांश देता है और तत्काल विश्लेषण प्रदान करता है',
        'btn_start': 'मुफ्त शुरू करें',
        'btn_demo': 'डेमो देखें',
        ...
        'cat1': 'बुनियादी सेवा जानकारी',
        'cat2': 'कॉल रिकॉर्डिंग और सारांश',
        'cat3': 'एआई वार्ता सहायक',
        'cat4': 'सुरक्षा और कानूनी',
        'cat5': 'मूल्य निर्धारण और संचालन',
        'cat6': 'अनुबंध और स्वचालन',
        'cat7': 'एआई से एआई कॉल',
        'cat8': 'बहुभाषी और वैश्विक'
    },
    'es': {
        'name': 'Español',
        'page_title': 'CallMind AI - Plataforma de Asistente de Llamadas con IA',
        'hero_title': 'Asistente de Llamadas<br>Inteligente con IA',
        'hero_subtitle': 'La IA responde llamadas, graba, resume y proporciona análisis instantáneo',
        'btn_start': 'Comenzar Gratis',
        'btn_demo': 'Ver Demo',
        'header_core': 'Características Principales',
        ...
        'cat1': 'Información Básica del Servicio',
        'cat2': 'Grabación y Resumen de Llamadas',
        'cat3': 'Asistente de Negociación con IA',
        'cat4': 'Seguridad y Legal',
        'cat5': 'Precios y Operaciones',
        'cat6': 'Contratos y Automatización',
        'cat7': 'Llamadas IA a IA',
        'cat8': 'Multilingüe y Global'
    },
    'fr': {
        'name': 'Français',
        'page_title': 'CallMind AI - Plateforme d\'Assistant d\'Appel IA',
        'hero_title': 'Assistant d\'Appel<br>Intelligent Alimenté par l\'IA',
        ...
        'header_industry': 'Solutions Sectorielles',
        ...
        'chatbot_subtitle': 'Questions Fréquemment Posées',
        'cat1': 'Informations de Base sur le Service',
        'cat2': 'Enregistrement et Résumé d\'Appels',
        'cat3': 'Assistant de Négociation IA',
        'cat4': 'Sécurité et Juridique',
        'cat5': 'Tarifs et Opérations',
        'cat6': 'Contrats et Automatisation',
        'cat7': 'Appels IA à IA',
        'cat8': 'Multilingue et Mondial'
    },
    'ar': {
        'name': 'العربية',
        'page_title': 'CallMind AI - منصة مساعد المكالمات بالذكاء الاصطناعي',
        'hero_title': 'مساعد مكالمات<br>ذكي مدعوم بالذكاء الاصطناعي',
        'hero_subtitle': 'يرد الذكاء الاصطناعي على المكالمات ويسجل ويلخص ويوفر تحليلاً فورياً',
        ...
        'stat1': 'اللغات',
        'stat2': 'دقة التعرف',
        'stat3': 'خدمة غير منقطعة',
        'stat4': 'وقت الاستجابة',
        'chatbot_title': 'مساعد الأسئلة الشائعة',
        'chatbot_subtitle': 'الأسئلة المتداولة',
        'cat1': 'معلومات الخدمة الأساسية',
        'cat2': 'تسجيل المكالمات والتلخيص',
        'cat3': 'مساعد التفاوض بالذكاء الاصطناعي',
        'cat4': 'الأمان والقانوني',
        'cat5': 'التسعير والعمليات',
        'cat6': 'العقود والأتمتة',
        'cat7': 'مكالمات الذكاء الاصطناعي إلى الذكاء الاصطناعي',
        'cat8': 'متعدد اللغات والعالمي'
    },
    'bn': {
        'name': 'বাংলা',
        'page_title': 'CallMind AI - এআই কল সহায়ক প্ল্যাটফর্ম',
        'hero_title': 'এআই-চালিত<br>বুদ্ধিমান কল সহায়ক',
        'hero_subtitle': 'এআই কল উত্তর দেয়, রেকর্ড করে, সারসংক্ষেপ করে এবং তাৎক্ষণিক বিশ্লেষণ প্রদান করে',
        'btn_start': 'বিনামূল্যে শুরু করুন',
        'btn_demo': 'ডেমো দেখুন',
        'header_core': 'মূল বৈশিষ্ট্য',
        'header_industry': 'শিল্প সমাধান',
        'header_pricing': 'মূল্য নির্ধারণ',
        'stat1': 'ভাষা',
        'stat2': 'স্বীকৃতি নির্ভুলতা',
        'stat3': 'নিরবচ্ছিন্ন সেবা',
        'stat4': 'প্রতিক্রিয়া সময়',
        'chatbot_title': 'FAQ সহায়ক',
        'chatbot_subtitle': 'প্রায়শই জিজ্ঞাসিত প্রশ্ন',
        'cat1': 'মৌলিক সেবা তথ্য',
        'cat2': 'কল রেকর্ডিং এবং সারসংক্ষেপ',
        'cat3': 'এআই আলোচনা সহায়ক',
        'cat4': 'নিরাপত্তা এবং আইনি',
        'cat5': 'মূল্য নির্ধারণ এবং পরিচালনা',
        'cat6': 'চুক্তি এবং স্বয়ংক্রিয়করণ',
        'cat7': 'এআই থেকে এআই কল',
        'cat8': 'বহুভাষিক এবং বৈশ্বিক'
    },
    'ru': {
        'name': 'Русский',
        'page_title': 'CallMind AI - Платформа голосового помощника с ИИ',
        'hero_title': 'Интеллектуальный<br>голосовой помощник с ИИ',
        'hero_subtitle': 'ИИ отвечает на звонки, записывает, резюмирует и предоставляет мгновенный анализ',
        ...
        'stat3': 'Непрерывная служба',
        'stat4': 'Время отклика',
        'chatbot_title': 'Помощник FAQ',
        'chatbot_subtitle': 'Часто задаваемые вопросы',
        'cat1': 'Основная информация об услугах',
        'cat2': 'Запись и резюме звонков',
        'cat3': 'ИИ помощник по переговорам',
        'cat4': 'Безопасность и юридические вопросы',
        'cat5': 'Цены и операции',
        'cat6': 'Контракты и автоматизация',
        'cat7': 'Звонки ИИ к ИИ',
        'cat8': 'Многоязычный и глобальный'
    },
    'pt': {
        'name': 'Português',
        'page_title': 'CallMind AI - Plataforma de Assistente de Chamadas com IA',
        'hero_title': 'Assistente de Chamadas<br>Inteligente com IA',
        'hero_subtitle': 'A IA atende chamadas, grava, resume e fornece análise instantânea',
        'btn_start': 'Comece Grátis',
        'btn_demo': 'Ver Demonstração',
        ...
        'cat1': 'Informações Básicas do Serviço',
        'cat2': 'Gravação e Resumo de Chamadas',
        'cat3': 'Assistente de Negociação com IA',
        'cat4': 'Segurança e Jurídico',
        'cat5': 'Preços e Operações',
        'cat6': 'Contratos e Automação',
        'cat7': 'Chamadas IA para IA',
        'cat8': 'Multilíngue e Global'
    }
}

# 번역 데이터 저장
with open('translations_all_11.json', 'w', encoding='utf-8') as f:
    json.dump(TRANSLATIONS, f, ensure_ascii=False, indent=2)

print(f"✅ {len(TRANSLATIONS)}개 언어 완전 번역 데이터 준비 완료")
print(f"언어: {', '.join(TRANSLATIONS.keys())}")
