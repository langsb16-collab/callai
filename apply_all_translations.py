...
# -*- coding: utf-8 -*-
"""
11개 언어 완벽 번역 - FAQ 35개 + 모든 UI 텍스트
"""
import json
import re
...
TRANSLATIONS = {
    'en': {
        ...
        'hero_title': 'AI-Powered Intelligent Call Assistant',
    ...
    'ja': {
        ...
        'hero_title': 'AI搭載インテリジェント通話アシスタント',
        ...
        'stat4': '応答時間',
        'features_title': 'コア機能',
        'features_subtitle': 'すべての通話をより賢く管理',
        'feat1_title': 'AI通話対応',
        ...
        'industry_subtitle': '最適化',
        'ind1_title': '介護',
        'ind1_desc': '患者レポート通信、緊急警告',
        'ind2_title': '建設現場',
        'ind2_desc': '現場調整、資材注文',
        'ind3_title': '配送サービス',
        'ind3_desc': '顧客リクエスト、位置通話',
        'ind4_title': '自営業',
        'ind4_desc': 'クライアント相談、見積通話',
        'ind5_title': 'フリーランサー',
        'ind5_desc': 'プロジェクト相談、契約交渉',
        'pricing_title': '料金',
        'pricing_subtitle': 'ニーズに合ったプランを選択',
        'footer_tagline': 'AI搭載通話アシスタントプラットフォーム',
...
# 먼저 영어, 중국어 간체/번체, 일본어만 저장
with open('translations_complete.json', 'w', encoding='utf-8') as f:
    json.dump(TRANSLATIONS, f, ensure_ascii=False, indent=2)

print(f"✅ {len(TRANSLATIONS)}개 언어 번역 데이터 준비 완료")
print("언어:", list(TRANSLATIONS.keys()))
